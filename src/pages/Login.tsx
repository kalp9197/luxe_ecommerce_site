...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-secondary/5 p-4">
      <motion.div
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Button variant="outline" type="button">
                  <img src="https://www.svgrepo.com/show/494278/facebook.svg" alt="Facebook" className="h-4 w-4 mr-2" />
                  Facebook
                </Button>
              </div>
            </CardContent>
